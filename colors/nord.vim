...
"+--- Editor ---+
call s:hi("ColorColumn", "", s:nord0_gui, "NONE", s:nord0_term, "", "")
...
call s:hi("LSPDiagnosticsVirtualTextWarning", s:nord3_gui, "", s:nord3_term, "", "", "")
call s:hi("LSPDiagnosticsVirtualTextError" , s:nord3_gui, "", s:nord3_term, "", "", "")
call s:hi("LSPDiagnosticsVirtualTextInformation" , s:nord3_gui, "", s:nord3_term, "", "", "")
call s:hi("LSPDiagnosticsVirtualTextHint" , s:nord3_gui, "", s:nord3_term, "", "", "")

call s:hi("LSPDiagnosticsSignWarning", s:nord13_gui, "", s:nord13_term, "", "", "")
call s:hi("LSPDiagnosticsSignError" , s:nord11_gui, "", s:nord11_term, "", "", "")
call s:hi("LSPDiagnosticsSignInformation", s:nord8_gui, "", s:nord8_term, "", "", "")
call s:hi("LSPDiagnosticsSignHint" , s:nord10_gui, "", s:nord10_term, "", "", "")
